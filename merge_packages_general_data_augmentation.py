...
import json
def resize():
    foolder = '/home/fariborz/PycharmProjects/data_augmentation/background_edit'
    folder_save = '/home/fariborz/PycharmProjects/data_augmentation/background_edit1/'
...
def data_engin(image_path, packages, background_path, aug_background, aug_package, image_id, object_id ,coco_data):
    ...
    json_address = '/media/fariborz/Bereket/SYNTHETIC_DATA_4/json_file/'
    ...
    for i in range(1, number_packages_in_scene):
        ...
        name_ = '/media/fariborz/Bereket/SYNTHETIC_DATA_4/synthetic_images/' + str(image_id) + '.png'
        cv2.imwrite(name_, back_img_save)
        annotated_name = '/media/fariborz/Bereket/SYNTHETIC_DATA_4/annotated_images/' + str(image_id) + '.png'
...
if __name__ =='__main__':
    ...
    background_path = '/home/fariborz/PycharmProjects/data_augmentation/background_edit1'
    #resize()
