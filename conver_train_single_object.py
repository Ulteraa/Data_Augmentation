...
counter_object_id = 0
counter_image_id = 0
# saved_ad = '/home/fariborz_taherkhani/SEGMENTED_LABELED_DATA/filter_RGBRight'
# saved_ad_anotated = '/home/fariborz/PycharmProjects/SwinT_detectron2-main/SEGMENTED_LABELED_DATA/anotated_RGBRight'
address = '/home/fariborz_taherkhani/train/trainSwinC.json'
file = open(address, 'r')
data = json.load(file)
...
new_address_images = '/home/fariborz_taherkhani/converted_single_ob'
curent_image = -10
...
#
# address = '/home/fariborz/PycharmProjects/SwinT_detectron2-main/SEGMENTED_LABELED_DATA/RGBright/sam_annotated_data_rGBRight.json'
#
# file = open(address, 'r')
#
# data = json.load(file)
#
# folder_path = '/home/fariborz/PycharmProjects/SwinT_detectron2-main/SEGMENTED_LABELED_DATA/RGBright/unlabled_RGBright/'
#
# for item in data['annotations']:
#     Flag = False
#     for img in data['images']:
